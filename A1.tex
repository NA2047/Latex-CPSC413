...
\hfill \break
\break
So in our worst case we need N Mailmen for N houses. Now each Mailman moves 2n-1 spaces on his route. so this means that if we have the worst case input where our houses are on an inverse angle from our start postion we will need to have N Mailmen move 2n-1 times.
This gives us a complexity of N(2N-1)
